    ...
    <div class="container">
        ...
        <div class="lines">
            ...
            <div class="row mt-4">
                ...
                <div class="text-center time_div" style="width:22%;">
                    <span class="display-5 timing fourth_time text-white">EN ATTENTE</span>
                </div>
            ...
            <div class="row mt-4">
                ...
                <div class="col-xs-4 col-sm-4 col-lg-4 col-md-4 text-center time_div" style="width:40%;">
                    <span class="display-5 timing third_time text-white">EN ATTENTE</span>
                </div>
            ...
            <div class="row mt-4">
                ...
                <div class="col-xs-6 col-sm-6 col-lg-6 col-md-6 text-center time_div" style="width:60%;">
                    <span class="display-5 timing second_time text-white">EN ATTENTE</span>
                </div>
            ...
            <div class="row mt-4">
                ...
                <div class="col-xs-8 col-sm-8 col-lg-8 col-md-8 text-center time_div" style="width:74%;">
                    <span class="display-5 timing first_time text-white">EN ATTENTE</span>
                </div>
